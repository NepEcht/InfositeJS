...
import * as sty from "./PlasmicButton.module.css"; // plasmic-import: LtqRT1LJmaR/css
import ChecksvgIcon from "./icons/PlasmicIcon__Checksvg"; // plasmic-import: LdlHg-b2pYM/icon
      ...
      {(
        ...
        >
          {p.renderPlasmicSlot({
            defaultContents: (
              <ChecksvgIcon
                className={classNames(projectcss.all, sty.svg__ysquC)}
                role={"img"}
              />
            ),
      ...
      {(hasVariant(variants, "showEndIcon", "showEndIcon") ? true : false) ? (
        ...
        >
          {p.renderPlasmicSlot({
            defaultContents: (
              <ChecksvgIcon
                className={classNames(projectcss.all, sty.svg__gzxWc)}
                role={"img"}
              />
            ),
